...
1. Clone your assignment repository into your ~/ops445/assignment2 directory using SSH:
```bash
git clone git@github.com:ops435/assignment2-duim.git ~/op445/assignment2/
```
...
```bash
vi ~/ops445/assignment2/a2_output.txt
```
